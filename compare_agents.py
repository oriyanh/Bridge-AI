...
compare_simple_agents_vs_ab_agents(depth=6, hand_size=3)
compare_simple_agents_vs_ab_agents(depth=9, hand_size=3)
compare_simple_agents_vs_ab_agents(depth=12, hand_size=3)
